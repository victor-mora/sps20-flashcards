...
@WebServlet("/setdeck")
public class SetDeckServlet extends HttpServlet {
...
//private HashSet<Entity> cardsInDeck = new HashSet<Entity>();
 ...
 //private boolean reshufflep = false;
  ...
  public void doGet(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException {
      ...
      session.setAttribute("selectedDeck", deckCode);

      request.getRequestDispatcher("/currdeck").forward(request, response);
      ...
      //     response.getWriter().println(gson.toJson("Current deck set to: " + deckCode));
