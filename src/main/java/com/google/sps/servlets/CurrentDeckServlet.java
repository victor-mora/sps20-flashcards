...
@WebServlet("/currdeck")
public class CurrentDeckServlet extends HttpServlet {
...
//private HashSet<Entity> cardsInDeck = new HashSet<Entity>();
 ...
 //private boolean reshufflep = false;
  ...
  public void doGet(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException {
      ...
      //String deckCode = request.getParameter("deckCode");

      String currDeck = (String)session.getAttribute("selectedDeck");

      String goodMessage = "Current deck set to: ";
      String badMessage = "No deck selected. Please select a deck to add cards to.";
      ...
      Gson gson = new Gson();
        ...
        if(currDeck == null || currDeck.equals("")){
response.getWriter().println(gson.toJson(badMessage));

        } else {
            response.getWriter().println(gson.toJson(goodMessage + currDeck));
