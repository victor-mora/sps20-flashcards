...
int i = 1;
      for(Entity entity : results.asIterable()){
          //long thiscardID = (long) entity.getProperty("cardID");
          String thisFront = (String) entity.getProperty("front");
          String thisBack = (String) entity.getProperty("back");

          cardNames.add(i + ".) " + thisFront + " ::: " + thisBack);
          i++;
      }
      ...
      Gson gson = new Gson();
        ...
        response.setContentType("application/json;");
          ...
          response.getWriter().println(gson.toJson(cardNames));
